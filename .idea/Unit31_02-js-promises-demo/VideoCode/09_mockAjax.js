...
function mockAjaxRequest() {
  return new Promise(function (resolve, reject) {
    ...
    // We mock a network request using a setTimeout. The request takes requestTime milliseconds.
    // Afterwords, the promise is either resolved with data or rejected with a timeout message,
    // based on whether randomNum is less than probSuccess.
    setTimeout(function () {
      let randomNum = Math.random();
      if (randomNum < probSuccess) {
